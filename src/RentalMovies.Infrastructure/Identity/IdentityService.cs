...
namespace RentalMovies.Infrastructure.Identity
{
    public class IdentityService:IIdentityService
    {
        ...
        public IdentityService(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, JwtSettings jwtSettings, IRentalMoviesDbContext context, TokenValidationParameters tokenValidationParameters)
        {
